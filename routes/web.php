...
Route::group(['middleware' => ['auth','admin']], function () {
    ...
    Route::resources([      
        ...
        'StoreShop'=>'StoreShopController',
        'StoreItem' => 'StoreItemController',
        'StoreOrder' => 'StoreOrderController',
        'StoreCoupon' => 'StoreCouponController',
    ...
    Route::post('/changeStoreOrderStatus', 'StoreOrderController@changeStoreOrderStatus');
    Route::post('/changeStoreOrderPaymentStatus', 'StoreOrderController@changeStoreOrderPaymentStatus');
    Route::get('/accept-store-order/{id}', 'StoreOrderController@accpetOrder');
    Route::get('/reject-store-order/{id}', 'StoreOrderController@rejectOrder');
    Route::get('/viewStoreOrder/{id}', 'StoreOrderController@viewsingleOrder');
    Route::get('/storeOrderInvoice/{id}', 'StoreOrderController@orderInvoice');
    Route::get('/printStoreInvoice/{id}', 'StoreOrderController@printStoreInvoice');
    Route::get('/storeRevenueReport', 'StoreOrderController@storeRevenueReport');
    Route::post('/storeRevenueFilter', 'CustomerController@storeRevenueFilter');
    Route::get('/shopCategory/{shop_id}', 'StoreShopController@shopCategory');
    Route::get('/itemSubcategory/{category_id}', 'StoreShopController@itemSubcategory');   
    ...
    Route::get('/StoreItem/gallery/{id}/edit', 'StoreItemController@viewGallery');
    Route::get('/StoreItem/gallery/{id}/add', 'StoreItemController@addGallery');
    Route::post('/StoreItem/gallery/{id}/store', 'StoreItemController@storeGallery');
    Route::delete('/StoreItem/gallery/{id}/delete/{name}', 'StoreItemController@deleteGallery');

    Route::post('/changeStoreOrderDriver', 'StoreOrderController@changeStoreOrderDriver');
});
