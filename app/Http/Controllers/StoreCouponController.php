...
class StoreCouponController extends Controller
{
    public function index()
    {
        ...
        return view('admin.coupon.viewStoreCoupon',['coupons'=>$data,'currency'=>$currency]);
    }

    public function create()
    {
        $location = Location::where('status',0)->get();
        return view('admin.coupon.addStoreCoupon',['location'=>$location]);
    }
