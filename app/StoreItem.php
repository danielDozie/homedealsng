...
class StoreItem extends Model
{
    ...
    {
        return $this->hasOne('App\StoreCategory', 'id', 'category_id');
    }

    public function subcategory()
    {
        return $this->hasOne('App\StoreSubCategory', 'id', 'subcategory_id');
    }
    ...
    {
        return StoreShop::find($this->attributes['shop_id'])->name;
    }
