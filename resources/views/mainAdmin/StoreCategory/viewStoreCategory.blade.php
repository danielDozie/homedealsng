                    ...
                    <div class="card form-card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">{{ __('Store Category') }}</h3>
                                </div>
                                <div class="col-4 text-right">
                                    <a href="{{url('StoreCategory/create')}}" class="btn btn-sm btn-primary">{{ __('Add Store Category') }}</a>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td >
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="{{url('StoreCategory/'.$category->id.'/edit')}}">{{ __('Edit') }}</a>
                                                            <a class="dropdown-item" onclick="deleteData('StoreCategory','{{$category->id}}');" href="#">{{ __('Delete') }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
