                        ...
                        <div class="card form-card bg-secondary shadow">
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h3 class="mb-0">{{ __('Add Store Category') }}</h3>
                                    </div>
                            ...
                            <div class="card-body">
                                <form method="post" action="{{url('StoreCategory')}}" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
