@php
    ...
    $categories = \App\StoreCategory::where('status',0)->orderBy('id','desc')->get();
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6">
						<div class="second-row-item">
							...
							<p style="color:#3e3f5e">
							We're one of the Nigeria's Finest Online Furniture and Homewares Retailers.
...
<br />
<br />
As we directly source and manufacture all our products from all over the world we'\re located in Lagos, Nigeria. As a result we cut out the middleman so we offer all our products at discount prices.

This means some of our products will be up to 75% cheaper than other retailers.
<br />
We are so confident that our prices are lowest in Nigeria and if you find exactly the same product cheaper, we offer a Price Match Service.
							</p>
						</div>
					</div>
						...
						<div class="second-row-item-payment">
							...
							<div class="footer-payments">
								<ul id="paypal-gateway" class="financial-institutes">
									...
									<li class="financial-institutes__logo">
									  <img alt="Flutterwave" title="Flutterwave" src="{{ url('frontend/images/footer-icons/flutterwave-3.svg') }}" style="width: 115px !important;">
									</li>
									<!-- <li class="financial-institutes__logo">
