...
@php
    ...
    foreach ($locations as $key => $location) {
        $shops = \App\StoreShop::where([['status',0],['location',$location->id]])->get();
        foreach ($shops as $key_shop => $shop) {
            $item = \App\StoreItem::where([['status',0],['shop_id',$shop->id]])->first();
...
<header class="header clearfix">
    <div class="top-header-group">
        <div class="top-header">
            ...
            <div class="select_location" style="visibility:hidden">
