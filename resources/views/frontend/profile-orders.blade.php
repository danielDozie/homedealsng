                                            ...
                                            <div class="track-order">
                                                ...
                                                @else
                                                    ...
                                                    <div class="bs-wizard" style="border-bottom:0;">   
                                                        ...
                                                        <div class="bs-wizard-step {{ $status == "Pending" || $status == "Approved" ? 'disabled':'' }}{{ $status == "OrderReady" || $status == "DriverAtShop" ? 'active':'' }}{{ $status == "OutOfDelivery" || $status == "PickUpStore" || $status == "OneTheWay" || $status == "Completed" ? 'complete':''  }}">
                                                            <div class="text-center bs-wizard-stepnum">{{__('Packed')}}</div>
                                                            <div class="progress"><div class="progress-bar"></div></div>
                                                            <a href="#" class="bs-wizard-dot"></a>
                                                        </div>
                                                        <div class="bs-wizard-step {{ $status == "Pending" || $status == "Approved" || $status == "OrderReady" || $status == "DriverAtShop" ? 'disabled':'' }}{{ $status == "OutOfDelivery" || $status == "PickUpStore" || $status == "OneTheWay" ? 'active':''  }}{{ $status == "Completed" ? 'complete':'' }}">
