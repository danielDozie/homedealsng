                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="product-dt-right">
                                    ...
                                    <div class="no-stock">
                                        @if ($product->stock <= 0)
                                            <p class="stock-qty">{{__('Not Available')}}<span style="color:red">{{__('(Out Of Stock)')}}</span></p>
                                        @else
                                            <p class="stock-qty">{{__('Available')}}<span style="color:green">{{__('(In stock)')}}</span></p>
                                        @endif
                                    </div>
                                    ...
                                    <div class="product-group-dt">
                                        <ul id="product-price">
                                            <li class="li-sell-price"><div class="main-price color-discount" style="color:#754c29"> {{__('Our Price')}} <span id="price"> {{$data['currency']}}<span class="product-sell_price">{{$product->sell_price}}</span></span></div></li>
                                            <li class="li-fake-price"><div class="main-price mrp-price"> {{__('Item Costs')}} <span id="fake_price"> {{$data['currency']}}<span class="product-fake_price">{{$product->fake_price}}</span> </span></div></li>
                                        </ul>
                                            ...
                                            <li>
                                                <div class="pdp-group-dt">
                                                    ...
                                                    <div class="pdp-text-dt">
                                                        ...
                                                        <p> {{__('We give you best of the market price on all items. Our prices can\'t be matched.')}} </p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="pdp-group-dt">
                                                    ...
                                                    <div class="pdp-text-dt">
                                                        ...
                                                        <p> {{__('Return items at doorstep without damages and get refund in minutes.')}} </p>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
