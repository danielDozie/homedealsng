                    ...
                    <div class="card form-card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">{{ __('Store Shops') }}</h3>
                                </div>
                                <div class="col-4 text-right">
                                    <a href="{{url('StoreShop/create')}}" class="btn btn-sm btn-primary">{{ __('Add Store Shop') }}</a>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="{{url('StoreShop/'.$shop->name)}}">{{ __('View') }}</a>
                                                            <a class="dropdown-item" href="{{url('StoreShop/'.$shop->id.'/edit')}}">{{ __('Edit') }}</a>
                                                            <a class="dropdown-item" onclick="deleteData('StoreShop','{{$shop->id}}');" href="#">{{ __('Delete') }}</a>
