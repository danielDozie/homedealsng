...
@section('content')
    @include('admin.layout.topHeader', [
        'title' => __('Edit Store Coupon') ,
        'headerData' => __('Store Coupon') ,
        'url' => 'StoreCoupon' ,
        'class' => 'col-lg-7'
    ]) 
                            ...
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-right">
                                        <a href="{{ url('StoreCoupon') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" id="add-coupon-form" action="{{url('StoreCoupon/'.$data->id)}}" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
                                    @method('put')
