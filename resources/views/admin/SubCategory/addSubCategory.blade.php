...
@section('content')
    @include('admin.layout.topHeader', [
        'title' => __('Add Store SubCategory') ,
        'headerData' => __('SubCategory') ,
        'url' => 'StoreSubCategory' ,
        'class' => 'col-lg-7'
    ])
                        ...
                        <div class="card form-card bg-secondary shadow">
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h3 class="mb-0">{{ __('Add Store SubCategory') }}</h3>
                                    </div>
                                    <div class="col-4 text-right">
                                        <a href="{{ url('StoreSubCategory') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{url('StoreSubCategory')}}" class="grocery_subcategory" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
