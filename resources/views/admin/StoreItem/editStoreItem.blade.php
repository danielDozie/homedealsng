...
@section('content')
    @include('admin.layout.topHeader', [
        'title' => __('Edit Store Item') ,
        'headerData' => __('Store Items') ,
        'url' => 'StoreItem' ,
        'class' => 'col-lg-7'
    ]) 
                            ...
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-right">
                                        <a href="{{ url('StoreItem') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{url('StoreItem/'.$data->id)}}" class="grocery-item" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
                                    @method('put')
                                            ...
                                            <div class="col-6">
                                                <div class="form-group{{ $errors->has('stock_unit') ? ' has-danger' : '' }}">
                                                    ...
                                                    <select name="stock_unit" id="input-stock_unit" class="form-control form-control-alternative{{ $errors->has('stock_unit') ? ' is-invalid' : '' }}" required>
                                                        ...
                                                        <option value="dozen" {{$data->stock_unit == 'dozen'?'selected':''}}> dozen </option>
                                        ...
                                        <div class="append">
                                            @foreach (json_decode($data->detail) as $key => $item)
                                                <div class="row {{$key != 0 ? 'mt-3':''}}">
                                                    ...
                                                    <div class="col-2">
                                                        <label class="form-control-label"> {{__("Homedeals Price")}} </label>
                                                        <input value="{{$item->price}}" type="number" name="price[]" class="form-control form-control-alternative" placeholder="Price" required>
                                                    </div>
                                                    <div class="col-2">
                                                        <label class="form-control-label"> {{__('Market Value')}} </label>
                                                        <input value="{{$item->fake_price}}" type="number" name="fake_price[]" class="form-control form-control-alternative" placeholder="Price" required>
                                                    </div>
