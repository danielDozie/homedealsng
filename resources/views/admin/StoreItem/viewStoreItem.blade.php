                ...
                <div class="card form-card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Store Item') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{url('StoreItem/create')}}" class="btn btn-sm btn-primary">{{ __('Add New Item') }}</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    u-right dropdown-menu-arrow">
                                                        {{-- <a class="dropdown-item" href="{{url('StoreItem/'.$item->id)}}">{{ __('View Item') }}</a> --}}
                                                        <a class="dropdown-item" href="{{url('StoreItem/'.$item->id.'/edit')}}">{{ __('Edit') }}</a>
                                                        <a class="dropdown-item" href="{{url('StoreItem/gallery/'.$item->id.'/edit')}}">{{ __('Gallery') }}</a>
                                                        <a class="dropdown-item" onclick="deleteData('StoreItem','{{$item->id}}');" href="#">{{ __('Delete') }}</a>
