        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card form-card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('StoreItem')}}" class="grocery-item"  autocomplete="off" enctype="multipart/form-data" >
                            @csrf
                                ...
                                <div class="append">
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            ...
                                            <input type="number" name="fake_price[]" class="form-control form-control-alternative" placeholder="Price" required>
                                        </div>
