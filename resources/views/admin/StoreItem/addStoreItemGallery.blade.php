...
@section('content')
    @include('admin.layout.topHeader', [
        'title' => __('Add Store Gallery') ,
        'headerData' => __('Store Item') ,
        'url' => 'StoreItem' ,
        'class' => 'col-lg-7'
    ])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card form-card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('/StoreItem/gallery/'.$data->id.'/store')}}" class="grocery-item"  autocomplete="off" enctype="multipart/form-data" >
                            @csrf
