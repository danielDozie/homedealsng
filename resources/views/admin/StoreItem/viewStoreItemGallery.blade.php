                ...
                <div class="card form-card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Store Item Gallery') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{url('/StoreItem/gallery/'.$data->id.'/add')}}" class="btn btn-sm btn-primary">{{ __('Add New Images') }}</a>
                            </div>
                        </div>
                    </div>
