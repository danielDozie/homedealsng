                                            ...
                                            <div class="tab-pane" id="additional-v">
                                                <form method="post" action="{{url('saveSettings')}}" autocomplete="off" enctype="multipart/form-data">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="form-group row {{ $errors->has('default_store_order_status') ? ' has-danger' : '' }}">
                                                            <div class="col-3">
                                                                <label class="form-control-label" for="input-default_store_order_status">{{ __('Default Order Status for Store') }}:</label>
                                                            </div>
                                                            <div class="col-9">
                                                                <select name="default_store_order_status" id="input-default_store_order_status" class="form-control form-control-alternative{{ $errors->has('default_store_order_status') ? ' is-invalid' : '' }}" required>
                                                                    <option value="">Select Defaut order Status</option>
                                                                    <option value="Pending" {{$setting->default_store_order_status=="Pending"?'Selected' : ''}}>Pending</option>
                                                                    <option value="Approved" {{$setting->default_store_order_status=="Approved"?'Selected' : ''}}>Approved</option>
                                                                </select>
                                                                @if ($errors->has('default_store_order_status'))
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $errors->first('default_store_order_status') }}</strong>
                                                                </span>
                                                                @endif
                                                            </div>
                                                        </div>
